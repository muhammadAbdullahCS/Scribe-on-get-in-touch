    ...
    <>
      ...
      <div className="mt-10 px-4 md:px-8 text-center pb-12 4k2:h-[89vh] flex flex-col 4k2:justify-around 4k2:items-center">
        ...
        hd:text-3xl 4k:text-4xl 4k2:text-6xl 4k2:w-2/4 ">
          Welcome back! Please log in to access your personalised dashboard and manage your transcription projects.
        </p>
        ...
        <div className="w-full xl:w-2/4 hd:w-[28rem] 4k:w-[34rem] 4k2:w-[60rem] mx-auto mb-10">
          ...
          <div className="flex items-center mb-8 text-sm sm:text-base md:text-lg lg:text-xl hd:text-2xl 4k:text-3xl 4k2:text-4xl">
            <input type="checkbox" className="mr-4 scale-125 4k2:scale-150" />
            <label className="text-black">Keep me logged in on this device.</label>
          </div>
        </div>
        ...
        <p className="text-black  text-sm sm:text-base md:text-lg lg:text-xl hd:text-2xl 4k:text-3xl 4k2:text-5xl">
          No Account? <a className="font-playfair text-transparent bg-clip-text bg-gradient-to-l from-[#5857F6] to-[#101052]" href="/signup">Create one</a>
        </p>

        <a className="font-playfair text-transparent bg-clip-text bg-gradient-to-l from-[#5857F6] to-[#101052] text-sm sm:text-base md:text-lg lg:text-xl hd:text-2xl 4k:text-3xl 4k2:text-5xl" href="">
          Forgot Password?
        </a>
      </div>
    </>
